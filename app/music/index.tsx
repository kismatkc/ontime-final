...
//     // 2️⃣ always give React a *new* reference

//     // 3️⃣ (optional) filter with current query
...
//     setSongs(result); // 👈 now React re-renders
//   }

//   // debounce search typing
//   useEffect(() => {
//     const id = setTimeout(() => refreshSongs(searchQuery), 400);
