      ...
      <DialogOverlay>
        ...
        >
          ...
          <DialogPrimitive.Close
            className={
              "absolute right-8 top-10 p-0.5 web:group rounded-sm opacity-70 web:ring-offset-background web:transition-opacity web:hover:opacity-100 web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2 web:disabled:pointer-events-none"
            }
          ></DialogPrimitive.Close>
        </DialogPrimitive.Content>
      </DialogOverlay>
